...
I've pulled information about the parties in power (and associated Prime Ministers) from [Wikipedia](https://en.wikipedia.org/wiki/List_of_prime_ministers_of_the_United_Kingdom) and added it to the dataset.
...
I've pulled information about GDP, unemployment, and inflation from the [World Bank Website](https://data.worldbank.org/indicator/NY.GDP.MKTP.CD?locations=GB) and added it to the dataset.
...
<tbody>
  <tr>
   ...
   <td style="text-align:right;"> 25 (1 missing obs. deleted) </td>
  </tr>
  <tr>
   <td style="text-align:left;font-weight: bold;"> Dependent variable </td>
   <td style="text-align:right;"> nominal_gbp_millions </td>
  </tr>
  <tr>
...
<tbody>
  <tr>
   <td style="text-align:left;font-weight: bold;"> F(3,21) </td>
...
<tbody>
  ...
  <tr>
   <td style="text-align:left;font-weight: bold;"> lagged_gdp_trillions </td>
  ...
  <tr>
   <td style="text-align:left;font-weight: bold;"> lagged_unemployment </td>
  ...
  <tr>
   <td style="text-align:left;font-weight: bold;"> pm_partyLabour </td>
