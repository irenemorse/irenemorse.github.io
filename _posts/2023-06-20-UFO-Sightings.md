...
[This week's Tidy Tuesday dataset](https://github.com/rfordatascience/tidytuesday/blob/main/data/2023/2023-06-20/readme.md) contains data on UFO sightings across the world (though the USA has by far the largest number of UFO sightings of any country).
...
![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
## Step 3: Identify Most Used Color Terms Within the Text
...
## Step 4: Examine Color Terms in Context
...
## Step 5: Visualize Color Terms in Context
...
![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-1.png)<!-- -->

``` r
prep_text(df=orange_words)
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-2.png)<!-- -->

``` r
prep_text(df=red_words)
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-3.png)<!-- -->

``` r
prep_text(df=green_words, my_color="green4")
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-4.png)<!-- -->

``` r
prep_text(df=blue_words)
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-5.png)<!-- -->

``` r
prep_text(df=black_words)
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-6.png)<!-- -->

``` r
prep_text(df=yellow_words, my_color="gold")
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-7.png)<!-- -->

``` r
prep_text(df=silver_words, my_color="snow4")
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-8.png)<!-- -->

``` r
prep_text(df=amber_words, my_color="goldenrod")
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-9.png)<!-- -->

``` r
prep_text(df=gray_words, my_color="gray40")
```

![](/assets/img/2023-06-20-UFO-Sightings_files/figure-html/unnamed-chunk-10-10.png)<!-- -->
